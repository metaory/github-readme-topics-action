...
const write = (data, path) => (0,promises_namespaceObject.writeFile)(path, JSON.stringify(data, null, 2));
...
async function run() {
  try {
    const octokit = new (dist_node.Octokit.plugin(plugin_paginate_rest_dist_node.paginateRest))({ auth });
